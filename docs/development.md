...
Карта модулей, типы, порядок шага и правила расширения находятся в отдельном
[разделе системы](./system/index.md). Результаты ревизии тестов и мутаций —
в [тестовом аудите](./system/testing.md). Проверка мутациями: `pnpm test:mutation`.
